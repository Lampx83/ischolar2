...
;(function ($w) {
    ...
    jm.mind.prototype = {
        ...
        add_node: function (parent_node, nodeid, topic, data, idx, direction, expanded) {
            ...
            if (node.level === 0)
                node.data['background-color'] = "#2A9D8F";
            else if (node.level === 1)
                node.data['background-color'] = "#428bca";
            else if (node.level === 2)
                node.data['background-color'] = "#E76F51";
            else if (node.level === 3)
                node.data['background-color'] = "#4d9a4e";
    ...
    jm.prototype = {
        ...
        click_handle: function (e) {
            ...
            if (this.get_node(nodeid) != null)
                showNode(this.get_node(nodeid));
        },
        ...
        _show: function (mind) {
            ...
            this.view.show(this.options.keep_center);
    ...
    jm.shortcut_provider.prototype = {
        ...
        handle_addchild: function (_jm, e) {
            ...
            if (!!selected_node) {
                ...
                if (node.level == 1)
                    node.data['background-color'] = "#739e52";
        ...
        handle_addbrother: function (_jm, e) {
            if (!editingNotes()) {
                ...
                if (!!selected_node && !selected_node.isroot) {
                    ...
                    node.data['background-color'] = selected_node.data['background-color'];
                    if (!!node) {
                        _jm.select_node(nodeid);
                        _jm.begin_edit(nodeid);
                    }
